...
*/
         ...
         * @param {
         ...
         deviceNum - The number of the Device associated with this
         switch.Passed on
         ...
         *
          * 
          * 
          * @property {number} number - The switch channel (relay) of the Bendit board associated with this switch's device.
