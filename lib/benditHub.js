        ...
        io.on('connection', (socket) => {
            ...
            console.log("A user connected." + " "+ socket.id);
                ...
                socket.on('handshake', function (data) {
                    ...
                    let deviceAssignedNumber = socket.deviceNumber;
                    
                    setTimeout(function () {
                        socket.to(`${socket.id}`).emit("setDeviceColor", deviceAssignedColor);
                        socket.to(`${socket.id}`).emit("setDeviceNumber", deviceAssignedNumber);
                ...
                this.collectAssignedDeviceData(socket.deviceAssignedData);
